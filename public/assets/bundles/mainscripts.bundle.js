...
$.AdminCompass = {}, $.AdminCompass.options = {
    ...
    activate: function() {
        ...
        $(window).on("click", function(e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("bars") && t.isOpen() && 0 === a.parents("#leftsidebar").length && (a.hasClass("js-right-sidebar") || r.fadeOut(), s.removeClass("overlay-open"))
            ...
            if ($(a.parents("ul")[0]).hasClass("list")) {
                var s = $(e.target).hasClass("menu-toggle") ? e.target : $(e.target).parents(".menu-toggle");
    ...
    checkStatuForResize: function(e) {
        ...
        }), s < 1170 ? (a.addClass("ls-closed"), t.fadeIn()) : (a.removeClass("ls-closed"), t.fadeOut())
    },
    isOpen: function() {
    ...
    activate: function() {
        ...
        $(window).on("click", function(e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("js-right-sidebar") && t.isOpen() && 0 === a.parents("#rightsidebar").length && (a.hasClass("bars") || r.fadeOut(), s.removeClass("open"))
        }), $(".js-right-sidebar").on("click", function() {
            s.toggleClass("open"), t.isOpen() ? r.fadeIn() : r.fadeOut()
        })
    },
    isOpen: function() {
...
$.AdminCompass.browser = {
    ...
    $.AdminCompass.browser.activate(), $.AdminCompass.leftSideBar.activate(), $.AdminCompass.rightSideBar.activate(), $.AdminCompass.navbar.activate(), $.AdminCompass.select.activate(), setTimeout(function() {
